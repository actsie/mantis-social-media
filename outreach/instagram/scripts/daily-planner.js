...
sessions.forEach(s => {
  ...
  const msg = [
    ...
    ``,
    `9. FOLLOW BUILDER — find 2-3 new people to engage with and follow:`,
    `   a. Scroll down to the comments section of the post you just commented on.`,
    `   b. Find 2-3 real people who also commented (skip business accounts, brands, accounts with 1000+ followers).`,
    ...
    `      - Comment on 1 post only if there is a genuine hook (same tone rules apply — no filler, no hype)`,
    ...
    ``,
    `10. Send a brief Telegram message using the message tool (channel="telegram", target="6241290513"): account name, what was posted or "liked only", + how many new follows added (e.g. "followed 2 new: @handle1, @handle2" or "no new follows"). ALWAYS include target="6241290513" — do NOT omit it.`,
  ].join('\n');
