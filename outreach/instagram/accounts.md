# Instagram Target Accounts — @stacyd0nna Engagement
...
## 🆕 Outreach Research Targets (added Mar 2)
⚠️ **RECENCY RULE:** Only engage on posts that are **7 days old or less**. If the most recent post is older than 7 days, skip this account and pick the next one. Do not comment on old posts.

Handles marked "verify" — confirm account exists and is active before engaging. Update status to ✅ or ❌ after first visit.

### 💅 Nail / Lash / Brow (full engagement)
...
### 💆 Spas & Multi-Service (like-only by default, comment on lash/nail/brow posts)

| Handle | Business | Notes | Status |
|--------|----------|-------|--------|
| @face_the_world_esthetics | Face the World Esthetics | Lauderhill FL, veteran-owned, 535 Groupon ratings | verify |
| @kismetcosmetics | Kismet | Mandeville LA, clean beauty + glitter bar | verify |
| @wmdayspa | WM DaySpa Salon | Rockford IL | verify |
| @aboutfacesdayspa | About Faces Day Spa | Maryland, full-service spa since 1970 | verify |
| @riseandglow | Rise & Glow | Boston, lashes/brows/tanning/waxing | verify |
| @brisknposh | BriskNPosh | Waxing, laser, threading spa | verify |
| @gbybeauty | GBY Beauty | LA + NY, lashes/brows/permanent makeup, 11 years | verify |

### ✂️ Brow & Threading (like + comment on brow/lash posts)
...
- **RECENCY RULE:** Only engage on posts ≤7 days old. Skip if newest post is older.
