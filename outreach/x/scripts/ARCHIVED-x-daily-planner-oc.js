...
sessions.forEach(s => {
  ...
  const msg = [
    ...
    ``,
    `BROWSER: Use profile="openclaw" for ALL browser tool calls. This browser is already logged into X as @stacydonna0x. Do NOT use profile="chrome" or the Chrome extension relay.`,
    ``,
    ...
    `   Wait 30-60 seconds, then check if anyone replied to your reply.`,
    `   `,
    `   If they replied:`,
    `   - **They answered/engaged** → Reply briefly with value`,
    `   - **They asked follow-up** → Reply with helpful info`,
