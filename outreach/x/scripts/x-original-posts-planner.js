...
const msg = [
  ...
  ``,
  `   Read /Users/mantisclaw/.openclaw/workspace/outreach/x/sources.md for source pairings and full flow instructions.`,
  ``,
  `   MODE 1 (Leads) or MODE 2 (Authority) — try QRT flow first:`,
  `   a. Check sources.md for which source pairs with your draft and the source's Twitter handle`,
  `   b. Navigate to the source's X profile and find the relevant stat tweet`,
  `      OR search: https://x.com/search?q=from%3A[handle]+[keyword]&src=typed_query`,
  `   c. If found: click Repost icon → click "Quote" → type your take → click Post`,
  `   d. If NOT found within 2 minutes: fall back to standard post (step e below)`,
  ``,
  `   FALLBACK or MODE 3/4 — standard post:`,
  `   e. Navigate to https://x.com`,
  `   f. Confirm profile is @stacydonna0x (check top-right avatar)`,
  `   g. Click the compose box ("What is happening?!" placeholder)`,
  `   h. Type the tweet text`,
  `   i. If Mode 1/2 and no QRT found: after posting, reply to own tweet with source URL`,
  `      (navigate to tweet URL → click Reply → paste article URL → click Reply)`,
  `   j. Click the "Post" button (NOT Ctrl+Enter)`,
  `   k. Take a snapshot to confirm it posted`,
  ``,
  ...
  `     postType: 'qrt OR standard OR thread',`,
  `     quotedTweetUrl: 'QUOTED TWEET URL OR null',`,
  `     replyUrl: 'REPLY URL IF THREAD FLOW OR null',`,
  `     platform: 'x',`,
